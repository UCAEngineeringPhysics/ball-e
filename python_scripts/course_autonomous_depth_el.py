...
#***********
from simple_odometry import SimpleOdometry # Assuming you saved the odometry class in a file named simple_odometry.py
#***********
...
class UserData:
    def __init__(self, serial_object):
        # Instead of serial.Serial(port_str), use the object passed in
        self.messenger = serial_object 
        # ... rest of your init ...
    ...
    def send_loop(self):
        """Background: ONLY send latest_msg to Pico. Let tracker handle the reading."""
        while self._running:
            try:
